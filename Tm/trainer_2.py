...
from data import SmilesTranslatorDataset, Vocab, ReVocab, CommonDataset
from modellayers import LikeGPT2, TransformerPre, LSTMModelPre
...
class LSTMModelPreTrainer(object):
    def __init__(self, model: LSTMModelPre, vocab,
                 train_dataloader: DataLoader, test_dataloader: DataLoader = None, valid_dataloader: DataLoader = None,
...
def train(train_setting):
    ...
    other_name = train_setting['other_name']
...
if __name__ == '__main__':
    ...
    train_setting = {'data_path': '../data/',
                     ...
                     'pre_dropout': 0.4,
                     'hidden_size': 384,
                     'learningrate': [0.001705442391309992, 16, 0.6],
                     'adam_beta1': 0.9,
                     'adam_beta2': 0.999,
